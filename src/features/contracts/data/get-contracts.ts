...
import { getContractsSchema } from './get-contracts-schema';
...
export const getContracts = authActionClient
  .metadata({ actionName: 'getContracts' })
  .inputSchema(getContractsSchema)
  .action(async ({ parsedInput, ctx }) => {
    ...
    const filteredContracts = await ctx.db
      .select({
        id: accountContractTable.id,
        account_customer_id: accountContractTable.account_customer_id,
        account_provider_id: accountContractTable.account_provider_id,
